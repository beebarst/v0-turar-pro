      ...
      <div className="mx-auto max-w-5xl">
        ...
        <div className="mt-20 md:mt-24 flex items-center justify-center gap-8 md:gap-16">
          <a
            ...
            aria-label="WhatsApp"
            className="glow-hover flex flex-col items-center gap-2 text-white/80 hover:text-[#25D366] transition-colors"
          >
            <WhatsAppIcon className="h-14 w-14 md:h-20 md:w-20" />
          ...
          <a
            ...
            rel="noopener noreferrer"
            aria-label="Telegram"
            className="glow-hover flex flex-col items-center gap-2 text-white/80 hover:text-[#229ED9] transition-colors"
          >
            <TelegramIcon className="h-14 w-14 md:h-20 md:w-20" />
          ...
          <a
            ...
            className="glow-hover flex flex-col items-center gap-2 text-white/80 hover:text-brand-red transition-colors"
          >
