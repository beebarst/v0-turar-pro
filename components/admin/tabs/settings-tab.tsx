      ...
      <div className="bg-neutral-900 border border-neutral-800 rounded-xl p-6">
        ...
        <div className="space-y-4">
          <div>
            ...
            <input
              type="text"
              value={settings.portfolioLabel}
              onChange={(e) => set("portfolioLabel", e.target.value)}
              className={inputCls}
            />
          </div>
          <div>
            ...
            <input
              type="text"
              value={settings.portfolioHeading}
          ...
          <div>
            ...
            <input
              type="text"
              value={settings.portfolioHeadingAccent}
              onChange={(e) => set("portfolioHeadingAccent", e.target.value)}
              className={inputCls}
            />
          </div>
        </div>
      ...
      <div className="bg-neutral-900 border border-neutral-800 rounded-xl p-6">
        ...
        <div className="space-y-4">
          <div>
            ...
            <input
              type="text"
              value={settings.calculatorLabel}
              onChange={(e) => set("calculatorLabel", e.target.value)}
              className={inputCls}
            />
          </div>
          <div>
            ...
            <input
              type="text"
              value={settings.calculatorHeading}
              onChange={(e) => set("calculatorHeading", e.target.value)}
              className={inputCls}
            />
          </div>
          <div>
            ...
            <input
              type="text"
              value={settings.calculatorHeadingAccent}
              onChange={(e) => set("calculatorHeadingAccent", e.target.value)}
              className={inputCls}
            />
          </div>
        </div>
        ...
        <div className="space-y-4">
          ...
          <div>
            ...
            <input
              ...
              onChange={(e) => set("contactHeadingAccent", e.target.value)}
              className={inputCls}
            />
          </div>
          <div>
